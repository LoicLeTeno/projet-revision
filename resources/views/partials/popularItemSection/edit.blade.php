<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __("Home (Popular Item Section Edit Id: $edit->id)") }}
        </h2>
    </x-slot>
        ...
        <div class="py-12">
            <div class="container sm:px-6 lg:px-8 flex justify-center mx-auto">
                <div class="w-full">
                    ...
                    <form action="/popularItemSection/{{ $edit->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="px-6 pt-3 pb-5">
                                            <div class="text-sm text-gray-900">
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    type="number" name="price" value="{{ $edit->price }}">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="px-6 pt-3 pb-5">
                                            <div class="text-sm text-gray-900">
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    type="number" name="view" value="{{ $edit->view }}">
                                            </div>
                                        </td>
                                        <td class="px-6 pt-3 pb-5">
                                            <div class="text-sm text-gray-900">
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    type="number" name="love" value="{{ $edit->love }}">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
